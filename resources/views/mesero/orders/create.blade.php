...
<head>
    ...
    <title>Crear Orden - D'Brasas y Carbon</title>
    <style>
        body {
...
<body>
    <header>
        <h1>Crear Orden - Mesa {{ $table->number }}</h1>
    ...
    <div class="content">
        ...
        <form action="{{ route('mesero.orders.store') }}" method="POST" id="orderForm">
            @csrf
            ...
            <div class="order-summary">
                ...
                <div class="form-actions">
                    <a href="{{ route('mesero.tables') }}" class="btn" style="background-color: #555; color: white;">Cancelar</a>
                    <button type="submit" class="btn" id="submitBtn" disabled>Crear Orden</button>
                </div>
            </div>
        </form>
    </div>
