...
<head>
    ...
    <title>Ticket de Cocina (Adicionales) - Orden #{{ $order->id }}</title>
    <style>
        /* Usar los mismos estilos que en la vista kitchen.blade.php */
        body {
...
<body>
    <div class="ticket-header">
        ...
        <div class="ticket-title">*** PRODUCTOS ADICIONALES ***</div>
    </div>
    ...
    <div class="additional-notice">
        ¡ATENCIÓN! PRODUCTOS ADICIONALES
    </div>
